...
Gem::Specification.new do |spec|
  ...
  # Per the spec, this should only include ruby executables in the `bin`
  # directory. Executables in other languages, and nested sub-directories, don't
  # appear to be supported.
  spec.executables   = ['yoyo']
